        ...
        <div class="navbar-logo">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="/dashboard">
            <div class="d-flex align-items-center">
              <div class="d-flex align-items-center"><img src="<?= ConfigHandler::get('app', 'logo') ?>" alt="<?= ConfigHandler::get('app', 'name') ?>" width="27" />
                <p class="logo-text ms-2 d-none d-sm-block"><?= ConfigHandler::get('app', 'name') ?></p>
              </div>
            </div>
          </a>
        </div>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-0 me-2 uil-chart-pie"></span>Home</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li><a class="dropdown-item active" href="/dashboard">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="home"></span>Dashboard</div>
                  </a></li>
                <li>
              </ul>
            </li>
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
                    ...
                    <div class="border-200">
                      <div class="px-2 px-sm-3 py-3 border-300 notification-card position-relative read border-bottom">
                        <div class="d-flex align-items-center justify-content-between position-relative">
                          <div class="d-flex">
                            <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="https://avatars.githubusercontent.com/u/87282334?v=4" alt="NaysKutzu" /></div>
                            <div class="flex-1 me-sm-3">
                              <h4 class="fs--1 text-black">NaysKutzu</h4>
                              <p class="fs--1 text-1000 mb-2 mb-sm-3 fw-normal"><span class='me-1 fs--2'></span>Welcome to MythicalClient!</span></p>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
              <div class="avatar avatar-l ">
                <img class="rounded-circle " src="<?= EncryptionHandler::decrypt($session->getUserInfo("avatar"), ConfigHandler::get("app", "key")) ?>" alt="" />
              </div>
            </a>
              ...
              <div class="card position-relative border-0">
                <div class="card-body p-0">
                  <div class="text-center pt-4 pb-3">
                    ...
                    <h5 class="mt-2 text-black"><?= EncryptionHandler::decrypt($session->getUserInfo("username"), ConfigHandler::get("app", "key")) ?></h5>
                    <h6 class="mt-2 text-black"><?= EncryptionHandler::decrypt($session->getUserInfo("first_name"), ConfigHandler::get("app", "key")) ?>, <?= EncryptionHandler::decrypt($session->getUserInfo("last_name"), ConfigHandler::get("app", "key")) ?></h6>
                  </div>
                ...
                <div class="overflow-auto scrollbar" style="height: 6.80rem;">
                  <ul class="nav d-flex flex-column mb-2 pb-1">
                    ...
                    <li class="nav-item"><a class="nav-link px-3" href="#!"> <span class="me-2 text-900" data-feather="lock"></span>Activity</a></li>
                ...
                <div class="card-footer p-0 border-top">
                  ...
                  <div class="my-2 text-center fw-bold fs--2 text-600"><a class="text-600 me-1" href="#!">Privacy policy</a>&bull;<a class="text-600 mx-1" href="#!">Terms of Service</a></div>
                </div>
              </div>
            </div>
          </li>
          ...
          <div class="modal-content mt-15 rounded-pill">
            <div class="modal-body p-0">
              <div class="search-box navbar-top-search-box" data-list='{"valueNames":["title"]}' style="width: auto;">
                <form class="position-relative" data-bs-toggle="search" data-bs-display="static" method="get" action="/lookup"><input class="form-control search-input fuzzy-search rounded-pill form-control-lg" name="s" placeholder="Search..." aria-label="Search" />
